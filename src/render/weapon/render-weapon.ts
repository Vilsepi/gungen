...
export function renderWeaponSvg(
  ...
  const drawing = `
    <style>
      .part { fill: rgba(37, 42, 47, 0.94); stroke: #a5b7c5; stroke-width: 2.4; stroke-linejoin: round; stroke-linecap: round; }
      .part line, .part path, .part rect, .part circle { vector-effect: non-scaling-stroke; }
      .optic { fill: rgba(140, 152, 163, 0.94); }
      .muzzle-device, .barrel { fill: rgba(134, 144, 155, 0.94); }
      .laser, .flashlight { fill: rgba(114, 127, 139, 0.95); }
